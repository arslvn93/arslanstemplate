            ...
            <div className="content-inner">
              ...
              >
                <p className="text-1 description-1 mb-14">
                  The home loan process can feel overwhelming, but I will help you stay
                  informed throughout, from pre-approval to closing.
                  The first step is consulting with a mortgage specialist.
                  If you don’t have one, I partner with some of the best lenders in the industry and would be happy to
                  introduce you.
                </p>
                <p className="description-2 text-1 mb-24">
                  {siteContent.loanProcess.factsDescription2}
                </p>
                <a
                  href="#"
                  ...
                  data-wow-delay="0s"
                >
                  {siteContent.loanProcess.factsButtonText}
                </a>
              </div>
