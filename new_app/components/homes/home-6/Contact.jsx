              ...
              <div className="box-contact style-1">
                <div className="heading-section mb-54 gap-33">
                  <div className="title text-white text-display-4 split-text effect-right">
                    <SplitTextAnimation text={siteContent.contactPage.formTitle} /> {/* Assuming reuse from contact page */}
                  </div>
            ...
            <div className="right">
              ...
              >
                ...
                <div className="wrap-btn">
                  ...
                  >
                    {siteContent.contactPage.formButtonText} {/* Assuming reuse from contact page */}
