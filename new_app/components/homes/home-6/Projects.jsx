          ...
          <div className="col-12">
            <div className="heading-section text-center gap-33 mb-56">
              <div className="title text-display-4 text_white split-text effect-right">
                <SplitTextAnimation text={siteContent.projects.sectionTitle} />
              </div>
              <p
                ...
                data-wow-delay="0s"
              >
                {siteContent.projects.introParagraph}
              </p>
            </div>
                ...
                <div className="project-item style-1 hover-image-2 item-1">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      ...
                      >
                        {siteContent.projects.storyTitles[0] || 'Client Success Story'}
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                        {siteContent.projects.storyTitles[5] || 'Client Success Story'} {/* Index 5 based on original layout */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                        {siteContent.projects.storyTitles[1] || 'Client Success Story'} {/* Index 1 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                        {siteContent.projects.storyTitles[6] || 'Client Success Story'} {/* Index 6 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                        {siteContent.projects.storyTitles[10] || 'Client Success Story'} {/* Index 10 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[2] || 'Client Success Story'} {/* Index 2 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[7] || 'Client Success Story'} {/* Index 7 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[3] || 'Client Success Story'} {/* Index 3 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[8] || 'Client Success Story'} {/* Index 8 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[11] || 'Client Success Story'} {/* Index 11 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[4] || 'Client Success Story'} {/* Index 4 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
                  ...
                  <div className="content">
                    ...
                    <div className="title text-14 fw-6">
                      <Link
                        ...
                        className="text_white link"
                      >
                         {siteContent.projects.storyTitles[9] || 'Client Success Story'} {/* Index 9 */}
                      </Link>
                    </div>
                  </div>
                  <Link href={siteContent.projects.linkTarget} className="tf-btn">
