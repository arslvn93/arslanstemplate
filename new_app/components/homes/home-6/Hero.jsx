                      ...
                      <div className="heading">
                        <div className="effect-item effect-1 effect-down">
                          <div
                            ...
                            dangerouslySetInnerHTML={{ __html: siteContent.hero.slides[0].title }} // Use title from siteContent (assuming one slide message now)
                          ></div>
                        </div>
                        <div className="item flex-wrap-sm">
                          <div className="img-wrap effect-item effect-left effect-2">
                            <Image
                              alt={siteContent.hero.slides[0].smallImage.alt} // Use alt from siteContent
                          ...
                          <div className="content effect-item effect-up effect-3">
                            <p className="text-1">{siteContent.hero.slides[0].description}</p> // Use description from siteContent
                            <a
                              href="#"
